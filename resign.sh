...
do
    case $opt in
        h)
            echo " exemple: "
            echo ' ./resign.sh -c "Apple Development: Jean-Baptiste Marce (J4RSD5687M)" -p support.mobileprovision -i youtube '
            echo " exemple en cas de présence de nouvelles couches à resigner: "
            echo ' ./resign.sh -c "Apple Development: Jean-Baptiste Marce (J4RSD5687M)" -p support.mobileprovision -i youtube -e "*.appex","*.dylib" '
